/* ====================================================================
   CASE PARAMÉTRICO COMPACTO KARTBOX (V37 - PEÇA DO MEIO RESTRUTURADA)
   ==================================================================== */
...
rebaixo_cabeca_profundidade  = 1.30; // CORREÇÃO: Rebaixo seguro e testado

// CONFIGURAÇÕES PARAMÉTRICAS DO CONECTOR USB-C
usbc_largura    = 8.25;  
usbc_altura     = 2.40;  
folga_usbc_furo = 0.30;  
usbc_shift_y    = 0.00;  // AJUSTE HORIZONTAL: (+) move para frente, (-) move para trás
usbc_shift_z    = 0.00;  // AJUSTE VERTICAL:   (+) move para cima,   (-) move para baixo
...
// 2. BERÇO INTERMEDIÁRIO - PEÇA AMARELA (CORRIGIDA: MAIS FINA / MENOS ESPESSA)
module berco_intermediario() {
    espessura_berco = 1.50; // CORREÇÃO: Deixado mais fino a pedido do usuário (antes era 3.00)
...
// 3. CAIXA TRASEIRA - PEÇA VERDE
module caixa_traseira() {
    raio_coluna_interna = diametro_furo_insert / 2 + 2.40; 
